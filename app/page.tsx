...
import { getFeaturedVehicles, getFeaturedTestimonials, getHeroMedia } from '@/lib/queries'
  ...
  return (
    <>
      ...
      <main id="main-content">
        <HeroSection videoUrl={heroMedia.videoUrl} posterUrl={heroMedia.posterUrl} />
              ...
              <>
                ...
                <ScrollReveal>
                  <div className="text-center">
                    <Link href="/inventory">
                      <Button variant="outline" size="lg">View All Vehicles</Button>
                    </Link>
                  </div>
                </ScrollReveal>
              </>
              ...
              <ScrollReveal>
                <div>
                  ...
                  <Link href="/procurement">
                    <Button variant="primary" size="lg">Start Procurement Request</Button>
                  </Link>
                </div>
              </ScrollReveal>
          ...
          <div className="container-max">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <ScrollReveal className="order-2 lg:order-1">
                <div className="bg-black rounded-lg border-2 border-primary-gold h-96 flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-5xl mb-4">💰</p>
              ...
              <ScrollReveal delay={150} className="order-1 lg:order-2">
                <div>
                  ...
                  <Link href="/sell-your-car">
                    <Button variant="primary" size="lg">Sell Your Car Now</Button>
                  </Link>
                </div>
              </ScrollReveal>
            </div>
                        ...
                        <Card variant="elevated" padding="lg">
                          <div className="flex gap-1 mb-4">
                            {Array.from({ length: testimonial.rating }).map((_, i) => (
                              <span key={i} className="text-primary-gold text-lg">★</span>
                            ))}
                          </div>
          ...
          <ScrollReveal>
            <div className="container-max text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                <Link href="/inventory">
                  <Button variant="primary" size="lg">Explore Inventory</Button>
                </Link>
                <Link href="/contact">
